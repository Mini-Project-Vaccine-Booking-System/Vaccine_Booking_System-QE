...
WebUI.scrollToElement(findTestObject('News/positive/button tampilkan lebih banyak'), 3)

WebUI.click(findTestObject('News/positive/button tampilkan lebih banyak'))

WebUI.click(findTestObject('News/positive/button baca selengkapnya'))
