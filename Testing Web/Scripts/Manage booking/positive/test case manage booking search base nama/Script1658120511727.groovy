...
WebUI.setText(findTestObject('Manage booking/positive/input search filter'), 'Cantika')

WebUI.sendKeys(findTestObject('Manage booking/positive/input search filter'), Keys.chord(Keys.ENTER))
