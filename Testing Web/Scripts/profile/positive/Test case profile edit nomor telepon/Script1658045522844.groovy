...
WebUI.sendKeys(findTestObject('Profile/positive/input nomor telepon'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Profile/positive/input nomor telepon'), Keys.chord(Keys.DELETE))

WebUI.delay(3)

WebUI.setText(findTestObject('Profile/positive/input nomor telepon'), '0243050807')
