...
WebUI.sendKeys(findTestObject('Profile/positive/input username'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Profile/positive/input username'), Keys.chord(Keys.DELETE))

WebUI.delay(3)

WebUI.setText(findTestObject('Profile/positive/input username'), 'rsdharmawangsa@gmail.com')
