...
WebUI.sendKeys(findTestObject('Profile/positive/input nama rs'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Profile/positive/input nama rs'), Keys.chord(Keys.DELETE))

WebUI.delay(3)

WebUI.setText(findTestObject('Profile/positive/input nama rs'), 'RS Dharmawangsa Semarang')
