...
WebUI.sendKeys(findTestObject('Profile/positive/input alamat'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Profile/positive/input alamat'), Keys.chord(Keys.DELETE))

WebUI.delay(3)

WebUI.setText(findTestObject('Profile/positive/input alamat'), 'JL Dharmawangsa no 1')
